...
1.1 Открываем ссылку с репозиторием – 📍
...
1.10 Заходим на страницу изначального проекта - 📍
...
2. Создать собственный репозиторий на github, куда загрузить страничку с прошлого занятия. 
